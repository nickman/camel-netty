...
public class NettyConfiguration implements Cloneable {
    ...
    public void parseURI(URI uri, Map<String, Object> parameters, NettyComponent component) throws Exception {
        ...
        if ((!protocol.equalsIgnoreCase("tcp")) && (!protocol.equalsIgnoreCase("udp")) && (!protocol.equalsIgnoreCase("local"))) {
        ...
        localName = component.resolveAndRemoveReferenceParameter(parameters, "localName", String.class, "netty");
    ...
    public boolean isLocal() {
        return protocol.equalsIgnoreCase("local");
    }
